...
var createDenseMatrixClass = factory(name5, dependencies5, (_ref) => {
    ...
    var _recurse = function recurse(value, index2) {
      if (isArray(value)) {
        return value.map(function(child, i2) {
          return _recurse(child, index2.concat(i2));
        });
      } else {
        return applyCallback(callback, value, index2, me, "map");
      }
    };
  ...
  DenseMatrix2.prototype.forEach = function(callback) {
    var me = this;
    var _recurse2 = function recurse(value, index2) {
      if (isArray(value)) {
        value.forEach(function(child, i2) {
          _recurse2(child, index2.concat(i2));
        });
      } else {
  ...
  DenseMatrix2.prototype[Symbol.iterator] = function* () {
    var _recurse3 = function* recurse(value, index2) {
      if (isArray(value)) {
        for (var i2 = 0; i2 < value.length; i2++) {
          yield* _recurse3(value[i2], index2.concat(i2));
        }
      } else {
        yield {
          value,
...
var createSparseMatrixClass = factory(name11, dependencies11, (_ref) => {
  ...
  SparseMatrix2.prototype.map = function(callback, skipZeros) {
    ...
    var invoke = function invoke2(v, i2, j) {
      return applyCallback(callback, v, [i2, j], me, "map");
    };
...
var name53 = "bitXor";
var dependencies53 = ["typed", "matrix", "DenseMatrix", "concat"];
...
var name60 = "xor";
var dependencies60 = ["typed", "matrix", "DenseMatrix", "concat"];
...
var createRound = factory(name91, dependencies91, (_ref) => {
  ...
  return typed2(name91, {
    ...
    "Unit, Unit": typed2.referToSelf((self) => (x, unit2) => self(x, 0, unit2)),
    "Array | Matrix, number, Unit": typed2.referToSelf((self) => (x, n, unit2) => {
      return deepMap(x, (value) => self(value, n, unit2), true);
    }),
    "Array | Matrix, BigNumber, Unit": typed2.referToSelf((self) => (x, n, unit2) => self(x, n.toNumber(), unit2)),
    "Array | Matrix, Unit": typed2.referToSelf((self) => (x, unit2) => self(x, 0, unit2)),
...
var name95 = "dotPow";
var dependencies95 = ["typed", "equalScalar", "matrix", "pow", "DenseMatrix", "concat"];
...
var dependencies96 = ["typed", "matrix", "equalScalar", "divideScalar", "DenseMatrix", "concat"];
...
var dependencies191 = ["typed", "bignumber", "add", "subtract", "divide", "multiply", "partitionSelect", "compare", "isInteger", "smaller", "smallerEq", "larger"];
